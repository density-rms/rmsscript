...
html_dir = "densitystatus/dailystatus"
apstats_dir = "/var/www/densitystatus/apstats"
clientstats_dir = "/var/www/densitystatus/clientstats"
capabilitystats_dir = "/var/www/densitystatus/clientcapability"    '''
...
if __name__ =='__main__':  
    ...
    summaryDict['ZD image'] = zdDict['zd_version']
    ...
    #capabilitystats_dir = zdDict['capabilitystats_dir']  
    #summaryDict = apStatsSort(new_date,summaryDict)
    #summaryDict = clientSort(new_date,summaryDict)
    #clientCapabilitySort(new_date)

    #summaryDict['ZD image'] ='9.12.0.0.177'
    ...
    message_fp.write('DENSITY network weekly report starting from  %s to %s is available in the following URL:\n\n' % (startdate, mydate))
    #message_fp.write('http://10.150.13.7/densitystatus/dailystatus/test.html')                     
    message_fp.write('http://%s/%s/%s' % (http_server,html_dir,new_reportfile))
    message_fp.close()
    filename = '/var/www/densitystatus/dailystatus/weekSummary.csv'
